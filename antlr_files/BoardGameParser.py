...
def serializedATN():
    return [
        ...
        177,5,59,0,0,177,184,5,72,0,0,178,179,5,3,0,0,179,180,5,59,0,0,180,
        ...
        228,5,72,0,0,228,229,5,14,0,0,229,230,3,18,9,0,230,231,5,44,0,0,
        ...
        5,17,0,0,246,247,5,72,0,0,247,248,5,61,0,0,248,249,3,26,13,0,249,
        250,5,62,0,0,250,35,1,0,0,0,251,252,5,18,0,0,252,253,5,72,0,0,253,
        254,5,19,0,0,254,264,5,68,0,0,255,256,5,18,0,0,256,257,5,72,0,0,
        257,258,5,20,0,0,258,259,5,72,0,0,259,260,5,61,0,0,260,261,3,14,
        7,0,261,262,5,62,0,0,262,264,1,0,0,0,263,251,1,0,0,0,263,255,1,0,
        0,0,264,37,1,0,0,0,265,266,5,18,0,0,266,267,5,72,0,0,267,268,5,21,
        ...
        1,0,0,0,275,276,5,22,0,0,276,277,5,72,0,0,277,278,5,21,0,0,278,281,
        ...
        286,5,23,0,0,286,287,5,72,0,0,287,288,5,21,0,0,288,291,5,61,0,0,
        ...
        0,298,299,5,72,0,0,299,300,5,19,0,0,300,310,5,68,0,0,301,302,5,22,
        0,0,302,303,5,72,0,0,303,304,5,20,0,0,304,305,5,72,0,0,305,306,5,
        ...
        5,72,0,0,313,314,5,19,0,0,314,324,5,68,0,0,315,316,5,23,0,0,316,
        317,5,72,0,0,317,318,5,20,0,0,318,319,5,72,0,0,319,320,5,61,0,0,
        320,321,3,14,7,0,321,322,5,62,0,0,322,324,1,0,0,0,323,311,1,0,0,
        0,323,315,1,0,0,0,324,43,1,0,0,0,325,326,5,26,0,0,326,327,5,72,0,
    ...
    def board_statement(self):
        ...
        try:
            ...
            if token in [18]:
                ...
                self._errHandler.sync(self)
                token = self._input.LA(1)
                if token in [40, 41, 42, 68, 69, 70, 71, 72]:
                    self.state = 269
                    self.param_list()
                    pass
                elif token in [3]:
